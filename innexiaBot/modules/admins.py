...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if not title:
        message.reply_text(f"Sucessfully promoted\n<b>{user_member.user.first_name or user_id}</b>!", parse_mode=ParseMode.HTML)
        return
    ...
    bot.sendMessage(
        chat.id,
       f"Sucessfully promoted <b>{user_member.user.first_name or user_id} With Title {title} </b>!",
