...
from innexiaBot.Handlers.managers import CMD_STARTERS, SpamChecker
from innexiaBot.Handlers.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from innexiaBot.Database import disable_sql as sql
